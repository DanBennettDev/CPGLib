...
System for musical creativity with Central Pattern Generators

Top level class is MatsuokaEngine
But may be useful to use other classes in isolation (e.g. MatsuNode if you just want a single oscillator)
